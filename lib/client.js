...
(() => {
  ...
  // src/locale.ts
  var LOCALE_NS = "dsh-restart-control";
  var zh = {
    "title": "\u91CD\u542F DSH",
  ...
  var API_PREFIX = "/dsh-restart-control/api";
...
.drb-desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}`;
  ...
  function RestartRow({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "drb-row", "data-dsh-restart-control": "1", children: [
  ...
  function apply(ctx) {
    ...
    }, "dsh-restart-control: dictionaries");
  ...
  self.__dsh_restart_control_entry__ = { apply, inject };
		...
		var entry = self.__dsh_restart_control_entry__;
